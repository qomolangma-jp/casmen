...
echo "Entry ID 10 のデータをクリーンアップします...\n";

// 既存のentryを削除
$entry = App\Models\Entry::find(10);
if ($entry) {
    echo "Entry ID 10 を削除中...\n";
    $entry->delete();
}

// 関連するentry_interviewsも削除
$interviews = App\Models\EntryInterview::where('entry_id', 10)->get();
...
// 結合済み動画も削除
$combinedFiles = glob(storage_path('app/public/interviews/combined_interview_10_*.mp4'));
