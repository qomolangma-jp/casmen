...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded-lg">
            <form method="POST" action="{{ route('master.question.store') }}" class="space-y-6">
                @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="q" name="q" rows="4" required
                                      ...
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 @error('q') border-red-300 @enderror">{{ old('q') }}</textarea>
                            @error('q')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <textarea id="memo" name="memo" rows="3"
                                      ...
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 @error('memo') border-red-300 @enderror">{{ old('memo') }}</textarea>
                            @error('memo')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" id="order" name="order" min="0" value="{{ old('order', 0) }}" required
